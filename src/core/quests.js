...
export const METRICS = {
  ...
  m3Level:       (ev) => g(ev, 'match', 'level'),
  m3Levels:      (ev) => g(ev, 'match', 'levels'),
  m3Stars:       (ev) => g(ev, 'match', 'stars'),
  m3Combo:       (ev) => g(ev, 'match', 'combo'),
  m3Specials:    (ev) => g(ev, 'match', 'specials'),
...
export const DAILY_POOL = [
  ...
  D('d_m3',       '🍓', 'Passe 2 fases no Pomar Mágico',      'm3Levels',     2,  90),
...
export const ACHIEVEMENTS = [
  ...
  A('a_m3first',  '🍓', 'Primeira colheita',  'Complete uma fase do Pomar Mágico', 'm3Levels',     1,  60),
  A('a_m3combo',  '💥', 'Cascata',            'Faça uma cascata x5 no Pomar Mágico', 'm3Combo',    5, 300, 'best'),
  A('a_m3stars',  '⭐', 'Constelação',        'Junte 30 estrelas no Pomar Mágico', 'm3Stars',     30, 400),
  A('a_m325',     '🏝️', 'Ilhéu',              'Chegue à fase 25 do Pomar Mágico',  'm3Level',     25, 500, 'best'),
  A('a_m3spec',   '🚀', 'Artilheiro',         'Use 100 especiais no Pomar Mágico', 'm3Specials', 100, 450),
