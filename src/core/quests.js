...
export const METRICS = {
  ...
  arMatches:     (ev) => g(ev, 'arena', 'matches'),
  arWon:         (ev) => g(ev, 'arena', 'won'),
  arKills:       (ev) => g(ev, 'arena', 'kills'),
  arMvp:         (ev) => g(ev, 'arena', 'mvp'),
...
export const DAILY_POOL = [
  ...
  D('d_ar1',      '🏟️', 'Jogue uma partida de Arena Clash', 'arMatches',    1, 100),
...
export const ACHIEVEMENTS = [
  ...
  A('a_arfirst',  '🏟️', 'Primeiro sangue',     'Elimine um herói no Arena Clash',  'arKills',        1,  80),
  A('a_arwin',    '🏆', 'Core destruído',      'Vença uma partida de Arena Clash', 'arWon',          1, 300),
  A('a_armvp',    '🌟', 'MVP',                 'Seja o MVP de uma partida',        'arMvp',          1, 350),
  A('a_arkills',  '⚔️', 'Caçador',             'Elimine 50 heróis no Arena Clash', 'arKills',       50, 600),
