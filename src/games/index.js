...
export const GAMES = [
  ...
  },
  {
    ...
    description: 'Match-3 de frutas mágicas: troque duas frutas vizinhas para juntar 3 iguais. Quatro viram um foguete, cinco viram a bomba de cor, em T ou L nasce a bomba — e combinar especiais explode o tabuleiro inteiro. Mapa de fases com gelo, caixas e correntes, estrelas que constroem a Ilha do Pomar, recompensa diária, roda da sorte, missões, baús e coleção.',
    category: 'puzzle',
    minPlayers: 1,
    maxPlayers: 1,
    soloOnly: true,
