...
export function buildMatchTextures(scene) {
  ...
  g.fillStyle(0xffb300, 0.62); g.fillRoundedRect(6, 6, 84, 84, 18); g.fillStyle(0xff8b3d, 0.5); g.fillCircle(30, 70, 14); g.fillCircle(66, 74, 10); g.fillStyle(0xffe58a, 0.7); g.fillEllipse(34, 30, 22, 12); g.lineStyle(3, 0xb5773a, 0.7); g.strokeRoundedRect(6, 6, 84, 84, 18); done('m3-honey', S);
  g.fillStyle(OUT, 1); g.fillRoundedRect(6, 6, 84, 84, 10); g.fillStyle(0x6f7590, 1); g.fillRoundedRect(10, 10, 76, 76, 8); g.fillStyle(0x4a5378, 1); g.fillCircle(48, 48, 22); g.fillStyle(0xc8ceda, 1); for (let i = 0; i < 8; i++) { const a = i * Math.PI / 4; g.fillRect(48 + Math.cos(a) * 24 - 4, 48 + Math.sin(a) * 24 - 4, 8, 8); } g.fillCircle(48, 48, 14); g.fillStyle(0x4a5378, 1); g.fillCircle(48, 48, 6); done('m3-gen', S);
